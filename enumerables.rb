...
def print_spicy_foods(spicy_foods)
  # your code here
 spicy_foods.map { |food| puts "#{food[:name]} (#{food[:cuisine]}) | Heat Level: #{'🌶'* food[:heat_level]}"}
...
def print_spiciest_foods(spicy_foods)
  # your code here
##spicy_foods.map {|food| puts "#{food[:name]} (#{food[:cuisine]})| Heat Level: #{'🌶'* (food[:heat_level] > 5)}"}
